...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-[600px] lg:min-h-[90vh] flex-col items-center justify-start overflow-hidden bg-slate-950 w-full z-0 pt-20 pb-0",
        className
      )}
    >
      ...
      <div className="relative z-50 flex -translate-y-40 flex-col items-center px-5 mt-20 mb-0">
        {children}
      </div>
    </div>
  );
