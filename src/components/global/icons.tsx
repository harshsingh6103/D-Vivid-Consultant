...
const Icons: IconType = {
    icon: (props: LucideProps) => (
        <svg {...props} viewBox="0 0 320 80" fill="none" xmlns="http://www.w3.org/2000/svg">
            {/* Triangle with stars (American flag inspiration) */}
            <path d="M0 0 L70 0 L35 60 Z" fill="currentColor" opacity="0.9"/>
            ...
            {/* Red stripes */}
            <rect x="0" y="45" width="70" height="3" fill="currentColor"/>
